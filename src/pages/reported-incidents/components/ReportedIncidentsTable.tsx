            ...
            {rows.length === 0 ? (
              ...
              rows.map((row) => (
                ...
                >
                  ...
                  <TableCell>
                    <span className="block truncate text-2sm text-slate-800" title={row.incidentType}>
                      {row.incidentType}
                    </span>
                  </TableCell>
                  <TableCell>
        ...
        <div className="flex shrink-0 flex-wrap items-center justify-end gap-0.5">
          ...
          {totalCount === 0 ? (
            <button
              type="button"
              disabled
              className="flex h-6 min-w-[1.5rem] items-center justify-center rounded border border-blue-500 bg-[#2e5f8a] px-0.5 text-xs font-medium text-white shadow-sm"
            >
              1
            </button>
          ) : (
