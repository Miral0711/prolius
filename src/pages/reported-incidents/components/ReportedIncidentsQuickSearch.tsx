...
interface ReportedIncidentsQuickSearchProps {
...
export function ReportedIncidentsQuickSearch({
  state,
  onChange,
  onSearch,
  onClear,
  registrationOptions,
}: ReportedIncidentsQuickSearchProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      ...
      <Input
        ...
        className="h-8 w-[165px] border-slate-200 bg-white text-2sm shadow-none placeholder:font-normal placeholder:text-slate-300 focus-visible:border-[#2e5f8a]/50 focus-visible:ring-2 focus-visible:ring-[#2e5f8a]/10"
      />
