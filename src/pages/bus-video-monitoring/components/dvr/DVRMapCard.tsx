    ...
    <div className="rounded-xl border border-white bg-white shadow-[0_2px_12px_-4px_rgba(0,0,0,0.08)] p-2.5 overflow-hidden transition-all hover:shadow-md">
      <div className="flex items-center justify-between mb-2.5 px-1">
        <div className="flex items-center gap-2">
          <div className="p-1 rounded-lg bg-[#e8f0f8]">
            <MapPin className="h-3 w-3 text-[#2e5f8a]" />
          </div>
        ...
        <div className="flex items-center gap-1 bg-[#f4f8fb] px-1.5 py-0.5 rounded-lg border border-slate-100">
      ...
      <div className="rounded-xl overflow-hidden border border-slate-100 h-[120px] relative bg-[#f4f8fb] group">
        <BusLiveMapCard 
