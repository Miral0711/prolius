...
interface VehicleDefectsAdvancedSearchProps {
...
export function VehicleDefectsAdvancedSearch({
  state,
  onChange,
  onSearch,
  onClear,
}: VehicleDefectsAdvancedSearchProps) {
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Input
          ...
          className="h-8 w-[180px] border-slate-200 bg-white text-2sm shadow-none placeholder:font-normal placeholder:text-slate-300"
        />
        <FilterDropdown
