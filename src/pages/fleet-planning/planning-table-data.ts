...
export const VEHICLE_ROWS: VehicleRow[] = [
  ...
  { id: 2,  registration: 'BUS-0112', division: 'South',  region: 'Region B', location: 'Depot 2',  supplier: 'FAMCO',       adrTest: d('22/07/2026','ok'),     annualService: d('18/05/2026','warning'), cambelChange: d('11/03/2026','overdue'), collection: d('25/06/2026','ok'),    pmi: d('14/07/2026','ok'),     brakeTest: d('08/04/2026','overdue') },
  ...
  { id: 4,  registration: 'BUS-0204', division: 'West',   region: 'Region A', location: 'Depot 4',  supplier: 'Trident',     adrTest: d('07/04/2026','overdue'), annualService: d('30/06/2026','ok'),     cambelChange: d('25/09/2026','ok'),    collection: d('03/04/2026','overdue'), pmi: d('18/08/2026','ok'),     brakeTest: d('20/05/2026','warning') },
  ...
  { id: 8,  registration: 'BUS-0304', division: 'West',   region: 'Region B', location: 'Depot 4',  supplier: 'FAMCO',       adrTest: d('04/04/2026','overdue'), annualService: d('17/05/2026','warning'), cambelChange: d('22/08/2026','ok'),    collection: d('14/06/2026','ok'),    pmi: d('09/04/2026','overdue'), brakeTest: d('18/09/2026','ok') },
  ...
  { id: 12, registration: 'BUS-0088', division: 'West',   region: 'Region C', location: 'Depot 4',  supplier: 'Al Futtaim',  adrTest: d('31/08/2026','ok'),     annualService: d('09/04/2026','overdue'), cambelChange: d('27/06/2026','ok'),    collection: d('16/08/2026','ok'),    pmi: d('02/05/2026','warning'), brakeTest: d('10/07/2026','ok') },
];

export const ASSET_ROWS: AssetRow[] = [
  { id: 1,  assetNumber: 'AST-1001', division: 'North',  region: 'Region A', location: 'Depot 1', adrTest: d('15/06/2026','warning'), annualService: d('01/04/2026','overdue'), corrosionInspection: d('20/08/2026','ok'),    electricalInspection: d('10/05/2026','warning'), ladenBrakeTest: d('05/04/2026','overdue'), lolerTest: d('30/09/2026','ok') },
  ...
  { id: 4,  assetNumber: 'AST-1004', division: 'West',   region: 'Region A', location: 'Depot 4', adrTest: d('07/04/2026','overdue'), annualService: d('30/06/2026','ok'),     corrosionInspection: d('25/09/2026','ok'),    electricalInspection: d('03/04/2026','overdue'), ladenBrakeTest: d('18/08/2026','ok'),     lolerTest: d('20/05/2026','warning') },
  ...
  { id: 8,  assetNumber: 'AST-1008', division: 'West',   region: 'Region B', location: 'Depot 4', adrTest: d('04/04/2026','overdue'), annualService: d('17/05/2026','warning'), corrosionInspection: d('22/08/2026','ok'),    electricalInspection: d('14/06/2026','ok'),    ladenBrakeTest: d('09/04/2026','overdue'), lolerTest: d('18/09/2026','ok') },
